    ...
    >
      <div className="mb-6 sm:mb-8 flex gap-4 sm:gap-8">
        <button
          ...
          className={`text-base sm:text-lg pb-2 transition-colors ${
      ...
      {activeTab === "profile" && (
        ...
        >
          <div className="mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-4">
              <div className="relative w-20 h-20 sm:w-24 sm:h-24">
                ...
                />
                {isEditMode && (
                  <button className="absolute -bottom-2 -right-2 w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center text-white transition-all hover:opacity-90 bg-[#81a1c7]">
              ...
              {!isEditMode && (
                <button
                  ...
                  className="px-4 sm:px-3 py-2 rounded-full text-white text-xs sm:text-xs transition-all hover:opacity-90"
                  style={{
                    background:
          ...
          {!isEditMode ? (
            <div className="space-y-4 sm:space-y-6 max-w-3xl text-base sm:text-lg md:text-xl">
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="w-full sm:w-auto px-12 sm:px-24 md:px-32 py-2.5 sm:py-3 rounded-xl text-white font-bold text-lg sm:text-xl md:text-2xl transition-all hover:opacity-90 bg-[#00C950]"
                >
                  Save
                </button>
              </div>
